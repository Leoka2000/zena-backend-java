...
public interface VoltageRepository extends JpaRepository<Voltage, Long> {
    ...
    List<Voltage> findByDevice_IdAndTimestampGreaterThanEqualOrderByTimestampAsc(Long deviceId, Long fromTimestamp);
    List<Voltage> findByDevice_IdOrderByTimestampAsc(Long deviceId);
}
